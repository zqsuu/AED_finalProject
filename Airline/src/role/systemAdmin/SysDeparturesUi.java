 ...
 * @author HP
 */
public class SysDeparturesUi extends javax.swing.JPanel {
    ...
    public SysDeparturesUi(Airport departuresList) {
        initComponents();
        displayDepartures();
...
//    }
    ...
    private void displayDepartures() {
        ...
        try {
            ...
            rs = st.executeQuery("Select idkey,routename,fallairport,departuretime,departureterminal from airlinedb1.route " );
