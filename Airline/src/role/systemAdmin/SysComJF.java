 ...
 * @author HP
 */
public class SysComJF extends javax.swing.JFrame {
    ...
    public SysComJF(LogIn login,AirlineCompany air) {
        initComponents();
        this.login = login;
        airlineCompany = air;
        //        if(routeList==null){
...
//        }
    ...
    private void tabOrderMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabOrderMouseClicked
        ...
        sysSplit.setRightComponent(order);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SysComJF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
