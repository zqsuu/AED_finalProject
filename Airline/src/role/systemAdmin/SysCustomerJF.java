 ...
 * @author HP
 */
public class SysCustomerJF extends javax.swing.JFrame {
     ...
     */
    public SysCustomerJF() {
        initComponents();
        this.login = login;
    }
    public SysCustomerJF(LogIn login,Customer cus) {
        initComponents();
        this.login = login;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SysCustomerJF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new SysCustomerJF(null,cus).setVisible(true);
            }
        });
    }
