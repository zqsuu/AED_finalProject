...
//        populateTable();
    ...
    private void initComponents() {
        ...
        tblArrange.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Arrange Id", "ROUTE NAME", "CAPTAIN", "PILOT1", "PILOT2", "ST.1", "ST.2", "ST.3"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblId24, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {cbCaptain, cbPilot1, cbPilot2, cbRN, cbSt1, cbSt2, cbSt3});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {cbCaptain, cbPilot1, cbPilot2, cbRN, cbSt1, cbSt2, cbSt3});
        ...
        if (arrangeId != 0) {
            ...
            try {
                ...
                String query = "UPDATE routecrew SET routename = '" + routeName + "'" + ",captain = '" + captain + "'" + ",pilot1 = '" + pilot1 + "'" + ",pilot2 = '" + pilot2 + "'"
                        + ",st1 = '" + st1 + "'" + ",st2 = '" + st2 + "'" + ",st3 = '" + st3 + "'" + " WHERE idarrange = " + arrangeId;
                Statement add = (Statement) con.createStatement();
                add.executeUpdate(query);
...
//                || cbType.getSelectedItem().equals("null")
        ...
        } else if(cbPilot1.getSelectedItem().equals(cbPilot2.getSelectedItem())) {
            JOptionPane.showMessageDialog(null, "Please Set Different Piolts!");
        } else if(cbSt1.getSelectedItem().equals(cbSt2.getSelectedItem())
                ||cbSt1.getSelectedItem().equals(cbSt3.getSelectedItem())
                ||cbSt2.getSelectedItem().equals(cbSt3.getSelectedItem())) {
            JOptionPane.showMessageDialog(null, "Please Set Different Steward/Stewardess!");
        }
        else {
            try {
                arrangeCount();
