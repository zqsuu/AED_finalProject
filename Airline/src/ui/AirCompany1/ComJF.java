...
public class ComJF extends javax.swing.JFrame {
    ...
    private void tabAirplaneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabAirplaneMouseClicked
        ...
        AirplaneUi airplane = new AirplaneUi(airlineCompany,login.getManufacturer());
    ...
    private void tabCrewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabCrewMouseClicked
        ...
        EmployeeUi employee = new EmployeeUi(airlineCompany);
    ...
    private void tabRouteCrewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabRouteCrewMouseClicked
        ...
        RouteCrewUi1 routeCrew = new RouteCrewUi1(airlineCompany);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LogIn l = new LogIn();        
                new ComJF(l,l.getAirCompany().getAirCompany().get(0)).setVisible(true);
            }
        });
    }
